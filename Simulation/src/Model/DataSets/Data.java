...
public class Data 
{
    ...
    public static DiscreteDataSet testRate = new DiscreteDataSet()
    {{
    ...
    public static DiscreteDataSet consumTV = new DiscreteDataSet()
    {{
    ...
    public static DiscreteDataSet cloudMap = new DiscreteDataSet()
    {{
