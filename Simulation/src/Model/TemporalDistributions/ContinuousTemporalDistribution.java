...
public class ContinuousTemporalDistribution implements ITemporalDistribution
{
    ...
    public ContinuousTemporalDistribution( DoubleUnaryOperator function, DoubleUnaryOperator primitive, Moment startingMoment, Moment endingMoment )
    {
